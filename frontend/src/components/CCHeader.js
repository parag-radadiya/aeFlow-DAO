...
function Header({ lgGraph }) {
  ...
  const back_url = "https://api.aeflowdao.cloud";
  ...
  return (
    <div className="fixed w-full flex items-center justify-between h-16 bg-gray-800 text-white">
      <h2
