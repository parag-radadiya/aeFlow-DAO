                ...
                <Grid container spacing={0} >
                    ...
                    <Grid item xs={12} xl={6} md={6} >
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                            <Button style={{ background: 'white'}} className='dao-btn' disableElevation > <Avatar alt="Remy Sharp" src={user} sx={{ width: '24px', height: '24px', marginRight: '10px' }} />{window.walletAddressView}</Button>
                        </Box>
                    </Grid>
                </Grid>
            </AppBar>
